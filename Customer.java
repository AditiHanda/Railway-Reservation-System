...
Connection cn;
    ...
    static int distance[][];
    public Customer() {
        String inputdistance="",inputcity="";
        initComponents();
        //down   try nhi lga toh
        try {
            MyConnection();
            st = cn.createStatement();
            String sql="select * from arraytable where serialnumer='1'";
        rs=st.executeQuery(sql);
        if(rs.next())
        {
            inputdistance=rs.getString("twodarray");
            inputcity=rs.getString("cityarray");
        }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, e);
        } finally {
...
//        String inputdistance="0 100000 10 100000 100000 0 100000 100000 10 100000 0 100000 100000 100000 100000 0 "; //select string from database
        String ar[]=inputdistance.split(" ");
		int size=ar.length;
		int size2=(int)Math.sqrt(size);
		//System.out.println(size2);
		int k=0;
		int a[][]=new int[size2][size2];
		for(int i=0;i<size2;i++)
			for(int j=0;j<size2;j++)
			{
				a[i][j]=Integer.parseInt(ar[k]);
				k++;
			}
                this.distance=a;
                //inputcity="a b c d ";
                String ar2[]=inputcity.split(" ");
                this.cities=ar2;
                this.vertex=ar2.length;
...
//		}
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (int i = 0; i < vertex ; i++) {
            ...
            {
                System.out.println("No Such Cities Found");
