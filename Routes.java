...
//				inputarray[i][j]=sc.nextInt();
        ...
        System.out.println(inputcity);//update database set input,cities;
        try {
            MyConnection();
            st = cn.createStatement();
            //String sql = "Select * From Register where Username='"+jText111.getText()+"'";

            String sql = "update arraytable set twodarray='" + inputdistance + "', cityarray='" + inputcity + "' where serialnumer='1'";
